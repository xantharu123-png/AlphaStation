...
STRATEGIES = {
    ...
    "Breakout Short": {
        "description": "Bearisher Breakout unter Support mit Volumen",
        "filters": {"Change %": (-50.0, -2.0), "RVOL": (1.2, 50.0), "Close Position": (0.0, 0.40)},
        "logic": "Kurseinbruch -2%+ unter Support + erhöhtes Volumen + Close nahe Low"
    },
    "Penny Rockets": {
...
BACKTEST_STRATEGY_RULES = {
    ...
    "Breakout Short": {
        "direction": "short",
        "description": "Bearisher Breakout unter Support: Change <-2%, Close nahe Low",
        "signal": {
            "change_pct_min": -50.0, "change_pct_max": -2.0,
            "close_pos_max": 0.40
        },
        "entry": "next_open",
        "stop_pct": 0.05,
