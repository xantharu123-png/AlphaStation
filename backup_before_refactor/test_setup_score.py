...
with open('/home/claude/scanner.py', 'r') as f:
    content = f.read()
match = re.search(r'(def calculate_setup_score\(.*?\n    return min\(100, max\(0, score\)\))', content, re.DOTALL)
exec(match.group(1))
print("✅ calculate_setup_score() geladen\n")
...
test("Nur Change=5%", calculate_setup_score(5.0,None,None,None,None,None,None,None,10,"long"), 25, 35)
